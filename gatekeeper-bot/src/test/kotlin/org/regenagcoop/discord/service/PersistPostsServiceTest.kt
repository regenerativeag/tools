...
class PersistPostsServiceTest {
    private val discordMocker = DiscordMocker()
    private val persistPostsService = PersistPostsService(discordMocker.mock, activeMemberConfig)
    ...
    inner class PersistMissingPostHistory {
        ...
        fun reloadTest(persistedCount: Int) = runBlocking {
            ...
            // when
            persistPostsService.persistMissingPostHistory(today, loadedPostHistory, persistedDates)
